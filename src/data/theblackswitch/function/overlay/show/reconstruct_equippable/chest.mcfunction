...
execute if items entity @s container.0 #theblackswitch:copper_chestplate run return run data modify storage theblackswitch:overlay equippable_reconstruct set value {"slot":"chest","asset_id":"minecraft:copper","equip_sound":"minecraft:intentionally_empty"}
