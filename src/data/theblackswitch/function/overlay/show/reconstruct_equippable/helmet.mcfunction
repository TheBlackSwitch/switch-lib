...
execute if items entity @s container.0 minecraft:copper_helmet run return run data modify storage theblackswitch:overlay equippable_reconstruct set value {"slot":"head","asset_id":"minecraft:copper","equip_sound":"minecraft:intentionally_empty"}
