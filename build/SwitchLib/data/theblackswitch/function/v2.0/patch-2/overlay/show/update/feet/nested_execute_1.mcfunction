function theblackswitch:v2.0/patch-2/overlay/show/reconstruct_equippable/feet
execute unless data entity @s Items[{Slot: 3b}].components."minecraft:custom_data"."tbs.overlay".equippable run function theblackswitch:v2.0/patch-2/overlay/show/update/feet/nested_execute_0
