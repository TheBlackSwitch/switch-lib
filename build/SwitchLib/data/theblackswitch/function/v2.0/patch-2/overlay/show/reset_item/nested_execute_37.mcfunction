item replace entity @s container.0 from entity @a[predicate=theblackswitch:v2.0/patch-2/player_id/match_search, limit=1] weapon.offhand
...
item replace entity @a[predicate=theblackswitch:v2.0/patch-2/player_id/match_search, limit=1] weapon.offhand from entity @s container.0
