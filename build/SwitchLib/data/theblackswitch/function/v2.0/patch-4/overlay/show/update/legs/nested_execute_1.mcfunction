function theblackswitch:v2.0/patch-4/overlay/show/reconstruct_equippable/legs
execute unless data entity @s Items[{Slot: 2b}].components."minecraft:custom_data"."tbs.overlay".equippable run function theblackswitch:v2.0/patch-4/overlay/show/update/legs/nested_execute_0
