function theblackswitch:v2.0/patch-4/overlay/show/reconstruct_equippable/helmet
execute unless data entity @s Items[{Slot: 0b}].components."minecraft:custom_data"."tbs.overlay".equippable run function theblackswitch:v2.0/patch-4/overlay/show/update/helmet/nested_execute_0
