...
execute if items entity @s inventory.* *[custom_data~{tbs.clear_inventory: true}] run function theblackswitch:v2.0/patch-4/clear_item/inventory_change/nested_execute_0
execute if items entity @s hotbar.* *[custom_data~{tbs.clear_hotbar: true}] run function theblackswitch:v2.0/patch-4/clear_item/inventory_change/nested_execute_1
