...
scoreboard players operation .t temp /= @s tbs.easing.duration
execute if score @s tbs.easing.ease matches 1 store result score .x temp run function theblackswitch:v2.0/patch-5/easing/functions/ease_in
execute if score @s tbs.easing.ease matches 2 store result score .x temp run function theblackswitch:v2.0/patch-5/easing/functions/ease_out
execute if score @s tbs.easing.ease matches 3 store result score .x temp run function theblackswitch:v2.0/patch-5/easing/functions/ease_in_out
execute if score @s tbs.easing.ease matches 4 store result score .x temp run function theblackswitch:v2.0/patch-5/easing/functions/linear
...
function theblackswitch:v2.0/patch-5/easing/run/teleport with storage theblackswitch:temp easing.displacement
...
execute if score @s tbs.easing.current_tick matches 0 if score @s tbs.easing.callback_id matches 0.. run function theblackswitch:v2.0/patch-5/easing/run/handle_callback
execute if score @s tbs.easing.current_tick matches 0 run function theblackswitch:v2.0/patch-5/easing/run/reset
