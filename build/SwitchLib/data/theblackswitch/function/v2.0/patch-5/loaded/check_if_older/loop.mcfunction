...
execute if function theblackswitch:v2.0/patch-5/loaded/check_if_older/is_older run return 1
return run function theblackswitch:v2.0/patch-5/loaded/check_if_older/loop
