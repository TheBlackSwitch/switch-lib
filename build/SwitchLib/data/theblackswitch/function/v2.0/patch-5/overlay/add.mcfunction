...
function theblackswitch:v2.0/patch-5/overlay/enable
execute unless data storage theblackswitch:overlay texture run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_0
execute unless data storage theblackswitch:overlay priority run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_1
execute unless data storage theblackswitch:overlay id run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_2
...
execute unless entity @s[type=minecraft:player] run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_3
...
execute if score #priority temp matches -1 run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_4
...
function theblackswitch:v2.0/patch-5/player_storage/get with storage theblackswitch:overlay player_storage
data remove storage theblackswitch:overlay player_storage
execute store success score #success temp run function theblackswitch:v2.0/patch-5/overlay/apply_storage/verify_id with storage theblackswitch:overlay
execute if score #success temp matches 1.. run return run function theblackswitch:v2.0/patch-5/overlay/add/nested_return_5
...
function theblackswitch:v2.0/patch-5/overlay/apply_storage/split
...
function theblackswitch:v2.0/patch-5/overlay/apply_storage/concat_post_insert
execute store result storage theblackswitch:overlay player_storage.player_id int 1 run scoreboard players get @s tbs.ID
data modify storage theblackswitch:overlay player_storage.path set value "theblackswitch.overlay"
data modify storage theblackswitch:overlay player_storage.source set value "storage theblackswitch:overlay data"
function theblackswitch:v2.0/patch-5/player_storage/set_from with storage theblackswitch:overlay player_storage
schedule function theblackswitch:v2.0/patch-5/overlay/clear_arguments 1 replace
function theblackswitch:v2.0/patch-5/overlay/show/update
