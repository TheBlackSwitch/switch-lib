item replace entity @s container.0 from entity @a[predicate=theblackswitch:v2.0/patch-3/player_id/match_search, limit=1] container.18
...
item replace entity @a[predicate=theblackswitch:v2.0/patch-3/player_id/match_search, limit=1] container.18 from entity @s container.0
