...
function theblackswitch:v2.0/patch-3/overlay/show/reset_item
...
execute summon chest_minecart run function theblackswitch:v2.0/patch-3/overlay/show/update/nested_execute_0
