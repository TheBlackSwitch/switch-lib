...
execute unless data storage theblackswitch:overlay data[1] run return run function theblackswitch:v2.0/patch-3/overlay/show/update/chest/nested_return_1
...
execute if score #should_modify temp matches 1 run function theblackswitch:v2.0/patch-3/overlay/show/update/chest/nested_execute_1
