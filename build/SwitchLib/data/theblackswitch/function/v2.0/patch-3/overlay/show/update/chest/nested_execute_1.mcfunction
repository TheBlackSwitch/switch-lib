function theblackswitch:v2.0/patch-3/overlay/show/reconstruct_equippable/chest
execute unless data entity @s Items[{Slot: 1b}].components."minecraft:custom_data"."tbs.overlay".equippable run function theblackswitch:v2.0/patch-3/overlay/show/update/chest/nested_execute_0
