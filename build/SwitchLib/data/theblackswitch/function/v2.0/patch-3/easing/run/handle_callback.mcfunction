...
function theblackswitch:v2.0/patch-3/easing/run/handle_callback/nested_macro_0 with storage theblackswitch:easing
function theblackswitch:v2.0/patch-3/easing/run/handle_callback/nested_macro_1 with storage theblackswitch:easing
