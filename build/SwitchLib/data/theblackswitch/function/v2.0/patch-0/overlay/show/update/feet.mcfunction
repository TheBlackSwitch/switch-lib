...
execute unless data storage theblackswitch:overlay data[3] run return run function theblackswitch:v2.0/patch-0/overlay/show/update/feet/nested_return_1
...
execute if score #should_modify temp matches 1 run function theblackswitch:v2.0/patch-0/overlay/show/update/feet/nested_execute_1
