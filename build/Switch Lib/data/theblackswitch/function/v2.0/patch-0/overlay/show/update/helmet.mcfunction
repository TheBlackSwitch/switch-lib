...
execute unless data storage theblackswitch:overlay data[0] run return run function theblackswitch:v2.0/patch-0/overlay/show/update/helmet/nested_return_1
...
execute if score #should_modify temp matches 1 run function theblackswitch:v2.0/patch-0/overlay/show/update/helmet/nested_execute_1
