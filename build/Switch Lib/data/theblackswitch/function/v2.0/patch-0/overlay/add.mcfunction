...
execute unless data storage theblackswitch:overlay texture run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_0
execute unless data storage theblackswitch:overlay priority run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_1
execute unless data storage theblackswitch:overlay id run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_2
...
execute unless entity @s[type=minecraft:player] run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_3
...
execute if score #priority temp matches -1 run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_4
...
execute store success score #success temp run function theblackswitch:v2.0/patch-0/overlay/apply_storage/verify_id with storage theblackswitch:overlay
execute if score #success temp matches 1.. run return run function theblackswitch:v2.0/patch-0/overlay/add/nested_return_5
...
function theblackswitch:v2.0/patch-0/overlay/apply_storage/split
