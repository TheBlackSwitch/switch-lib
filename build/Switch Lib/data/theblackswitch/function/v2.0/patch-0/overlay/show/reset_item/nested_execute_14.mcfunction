item replace entity @s container.0 from entity @a[predicate=theblackswitch:v2.0/patch-0/player_id/match_search, limit=1] container.14
...
item replace entity @a[predicate=theblackswitch:v2.0/patch-0/player_id/match_search, limit=1] container.14 from entity @s container.0
