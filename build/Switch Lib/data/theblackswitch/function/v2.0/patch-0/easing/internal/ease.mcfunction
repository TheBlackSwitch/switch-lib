...
execute store result storage theblackswitch:v2.0/patch-0/temp easing.displacement.x float 0.001 run scoreboard players operation .displ_x temp -= @s tbs.easing.prev_x

scoreboard players operation .displ_y temp = .curr_y temp
execute store result storage theblackswitch:v2.0/patch-0/temp easing.displacement.y float 0.001 run scoreboard players operation .displ_y temp -= @s tbs.easing.prev_y

scoreboard players operation .displ_z temp = .curr_z temp
execute store result storage theblackswitch:v2.0/patch-0/temp easing.displacement.z float 0.001 run scoreboard players operation .displ_z temp -= @s tbs.easing.prev_z

scoreboard players operation .displ_yaw temp = .curr_yaw temp
execute store result storage theblackswitch:v2.0/patch-0/temp easing.displacement.yaw float 0.001 run scoreboard players operation .displ_yaw temp -= @s tbs.easing.prev_yaw

scoreboard players operation .displ_pitch temp = .curr_pitch temp
execute store result storage theblackswitch:v2.0/patch-0/temp easing.displacement.pitch float 0.001 run scoreboard players operation .displ_pitch temp -= @s tbs.easing.prev_pitch
...
function theblackswitch:v2.0/patch-0/easing/internal/teleport with storage theblackswitch:v2.0/patch-0/temp easing.displacement
